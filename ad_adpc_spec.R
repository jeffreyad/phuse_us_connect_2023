...
adpc_spec <- readxl::read_xlsx("./specs/adpc_spec.xlsx", sheet = "Variables") %>%
...
dir <- '.'
#tempdir() # Change to whichever directory you want to save the dataset in
