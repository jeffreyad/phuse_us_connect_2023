...
Note `ADTM_prev` is the Datetime of the Previous Dose 
`AVISIT_prev` is the Analysis Visit of the Previous Dose
...
Note `ADTM_next` is the Datetime of the Next Dose
...
Note `NFRLT_prev` is the Nominal Relative Time from the Previous Dose 
`NFRLT_next` is the Nominal Relative Time for the Next Dose
...
`AFRLT` Actual Relative Time from Analyte First Dose 
`ARRLT` Actual Relative Time from Reference Dose
...
`NFRLT` Nominal Relative Time from Analyte First Dose 
`NRRLT` Nominal Relative Time from Reference Dose
