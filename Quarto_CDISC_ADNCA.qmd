...
Actual times may be used to calculate parameters
Nominal times may be used to group output in tables
:::
...
<https://github.com/pharmaverse>{target="_blank"}
...
`ADTM_prev` is the datetime of the previous dose 
...
`NFRLT_prev` is the nominal relative time from the previous dose 
